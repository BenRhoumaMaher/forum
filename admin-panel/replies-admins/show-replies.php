        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table mt-4">
                    ...
                    <tbody>
                        <?php foreach($fetch as $reply) : ?>
                        <tr>
                            <th scope="row"><?php echo $reply->id; ?></th>
                            <td><?php echo $reply->reply; ?></td>
                            <td><?php echo $reply->user_image; ?></td>
                            <td><?php echo $reply->user_name; ?></td>
                            <td><a href="http://localhost/forum/topics/topic.php?id=<?php echo $reply->topic_id; ?>"
                                    target="_blanc" class="btn btn-success text-center ">go to topic</a></td>
